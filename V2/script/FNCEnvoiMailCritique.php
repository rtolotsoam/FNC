<?php
   ...
   function mailEnvoiFnc($slctClientName,$slctCode,$slctGravite,$slctFrequence,$txtMotif) 
   {
      ...
      <div id='id_div_corps_mail'>
         ...
         <!--<a class='link' href='http://192.168.10.24/gpao2/fnc/V2/script/FNCSearch.php?slctClientName=".$slctClientName."&txtCrationDate=".$date_du_jour."&txtModifDate=".$date_du_jour."&motif_fnc=&btnSubmit=Rechercher&search=1'><b>Voici le lien vers la GPAO sur la FNC cr&eacute;&eacute;e</b></a>-->
         <a class='link' href='http://192.168.10.24/gpao2/fnc/V2/script/FNCSearch.php?slctClientName=".$sCli."&txtCrationDate=".$date_du_jour."&txtModifDate=".$date_du_jour."&motif_fnc=&btnSubmit=Rechercher&search=1'><b>Voici le lien vers la GPAO sur la FNC cr&eacute;&eacute;e</b></a>
         </div>";
       ...
       $mail->AddCC('chq_vivetic@vivetic.mg', 'chq_vivetic@vivetic.mg'); 	// adresse en copie
       	// adresse en copie
