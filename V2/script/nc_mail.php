...
<a class='link' href='http://192.168.10.24/gpao2/fnc/V2/script/FNCSearch.php?slctClientName=".$idclient."&txtCrationDate=".$date_fnc."&txtModifDate=".$date_fnc."&motif_fnc=".$id_tlc_fnc."&btnSubmit=Rechercher&search=1'>lien vers la gpao sur la FNC cr&eacute;&eacute;e via la grille </a>
</div>";
