...
<?php
	...
	*/
	...
	$entete .= "	<table id=\"tabNC\" name=\"tabNC\" cellspacing=\"1\" cellpadding=\"1\">
					<tr class=\"entete\"><thead style='font: 12px/18px Arial, Sans-serif;'>
						<th colspan=\"7\" align=\"center\">FNC</th>
                  <th ></th>
                 <!-- <th rowspan=\"2\">Gravit&eacute;/Impact</th>-->
						...
						<th rowspan=\"2\">
							<select style=\"width: 100px\" class=\"entete\" id=\"slctTypologie\" name=\"slctTypologie\" onchange=\"optionChange();\">
			...
			$entete .= "	</select>
						...
						<th rowspan=\"2\">
							<select style=\"width: 100px\" class=\"entete\" id=\"slctImputation\" name=\"slctImputation\" onchange=\"optionChange();\">
			...
			$entete .= "	</select>
                   ...
                   <th ></th>
					...
					<th> R&eacute;ference
						...
						<th>
							<select style=\"width: 75px\" class=\"entete\" id=\"slctClient\" name=\"slctClient\" onchange=\"optionChange();\">
                    ...
                    <select style=\"width: 45px\" class=\"entete\"  {$sStyle} id=\"slctBU\" name=\"slctBU\" onchange=\"optionChange();\">
					...
					$entete .= "</select>
                     ...
                     <th>
							<select style=\"width: 75px\" class=\"entete\" id=\"slctCode\" name=\"slctCode\" onchange=\"optionChange();\">
					...
					$entete .= "</select>
							...
							<th>
								<select style=\"width: 75px\" class=\"entete\" id=\"slctStatut\" name=\"slctStatut\" onchange=\"optionChange();\">
							...
							<th>
								<select style=\"width: 75px\" class=\"entete\" id=\"slctType\" name=\"slctType\" onchange=\"optionChange();\">
				...
				$entete .= "	<!--/select-->
							...
							<!--th>
								<select style=\"width: 100px\" class=\"entete\" id=\"slctProcess\" name=\"slctProcess\" onchange=\"optionChange();\">
				...
				*/
				$entete .= "<!--th>
								<select style=\"width: 100px\" class=\"entete\" id=\"slctModule\" name=\"slctModule\" onchange=\"optionChange();\">
            ...
            <th data-sorter='false' style='padding-top: 5px; padding-left: 5px' align=\"center\" >Date de d&eacute;but</th>
            ...
            <th data-sorter='false' align=\"center\" style='padding-top: 12px;padding-left: 5px' >Validation action</th>
