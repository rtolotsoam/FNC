...
<html>
        ...
        if(isset($_REQUEST['curative']))
        {
         echo "
            <script type='text/javascript'>
              ...
              document.location.replace('FNCModifier.php?txtId='+varId2+'&txtRef='+varZRef+'&txtNameClient='+slctClientName+'&txtCrationDate='+txtCrationDate+'&txtModifDate='+txtModifDate+'&txtCreateurMatr='+txtCreateurMatr+'&motif_fnc='+motif_fnc+'&curative='+curative);
            </script>";
        }
        if(isset($_REQUEST['corrective']))
        {
          echo "
            <script type='text/javascript'>
               ...
               var motif_fnc = $('#bnc_motif').val();
               var curative = $('#curative').val();
              document.location.replace('FNCModifier.php?txtId='+varId2+'&txtRef='+varZRef+'&txtNameClient='+slctClientName+'&txtCrationDate='+txtCrationDate+'&txtModifDate='+txtModifDate+'&txtCreateurMatr='+txtCreateurMatr+'&motif_fnc='+motif_fnc+'&corrective=corrective');
            </script>";
        }
        else
        {
   ...
   function myReload2()
   {
	   ...
	   alert('9999');
        ...
        if(matrSession != 6548 && matrSession != 7530 && matrSession != 42 && (fncStatutBoucle == 'boucl\351'))
        {
             disableInput('btnSupprimer');
        ...
        if(matrSession != 6548 && matrSession != 7530 && matrSession != 42)
        {
          disableInput('btnSupprimer');
          // alert('4');
        }
