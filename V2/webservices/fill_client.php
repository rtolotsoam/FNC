...
for ($i = 0; $i < @pg_num_rows ($rQueryClient); $i ++) {
   ...
   $sClient = $aData['nom_client'] ;
	...
	if ($sClientName == $sClient) $sNotAudit .= " selected";
