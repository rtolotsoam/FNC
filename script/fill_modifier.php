...
// $COQUAL = findGroup($conn) ;
  ...
  // echo "te ".$slctClientName." - ".$slctCode." - ".$txtCrationDate." - ".$txtModifDate." - ".$txtCreateurMatr." - ".$s_txtCP ." - ".$slctTraitStatut." - ".$slctType ." - ".$slctTraitStatutCor." ato" ;
  //AUDITEUR SY CHARGER DE QUALITE
  
  $array_admin = array(6550,7122,5066,5196,7530,6548,6491,5049,42,5270);
?>
  ...
  <div >
         ...
         <table  border="1" width="70%">
            ...
            <tr>
               ...
               <?php
                  if($oFNC['fnc_statut'] != "bouclé"){
                     echo "<select id = \"txtComm\" name = \"txtComm\" style='width:200px;' >" ;
            ...
            <tr>
               ...
               <td class="class3" colspan="2">
                  <?php
                  if($oFNC['fnc_statut'] != "bouclé"){
                     echo "<textarea id=\"txtAreaMotif\" name=\"txtAreaMotif\" style='width: 950px;'>". $oFNC['fnc_motif'] ."</textarea>" ;
                  }
                  else{
                     echo $oFNC['fnc_motif'] ;
                  }
            ...
            <tr>
               ...
               <?php
                  if($oFNC['fnc_statut'] != "bouclé"){
                     echo "<textarea id=\"txtAreaExegence\" name=\"txtAreaExegence\" style='width: 950px;'>". $oFNC['fnc_exigence'] ."</textarea>" ;
                  }
                  else{
            ...
            <tr>
               <td class="class3">CRITICITE</td>
                  ...
                  <?php
					...
					if( in_array( $_SESSION['matricule'], $array_admin ) )
                     {
                        echo "<td class=\"class3\">" ;
                        echo "Gravit&eacute; : <select id=\"slctGravite\" name=\"slctGravite\" style='width:200px;'> " ;
                        ...
                        echo "Fr&eacute;quence : <select id=\"slctFrequence\" name=\"slctFrequence\" style='width:200px;'> "; 
           ...
           <tr>
            ...
            <tr>
               ...
               <td class="class4" colspan="2">
                  ...
                  <?php
                     ...
                     else
                     {
                        for($i = 0; $i < $iNbAppar; $i ++)
                        {
                           ...
                           echo "<tr>
                                 <td>
                                    <textarea id = \"txtMotifAppar".$i."\" name = \"txtMotifAppar".$i."\" style='width: 950px;'>". $toMotAppar['libelle'] ."</textarea>
                                 </td>
                              </tr>" ;
                        }
                     }
                  ...
                  <tr>
                  <td align="right">
                           <input type="button" id="btnAjoutMot" name="btnAjoutMot" value="Ajout motif" class = "ui-state-default" onclick = "motifAppat('<?php echo $zRef;  ?>');">
                   </td>
                     </tr>
                  </table>
               </td>
            ...
            <tr>
               ...
               <td class="class4" colspan="2">
                  ...
                  <?php
                     ...
                     else
                     {
                        for($i = 0; $i < $iNbDetect; $i ++)
                        {
                           ...
                           echo "<tr>
                                 <td>
                                    <textarea id = \"txtMotifDetect".$i."\" name = \"txtMotifDetect".$i."\" style='width: 950px;'>". $toMotDetect['libelle'] ."</textarea>
                                 </td>
                              </tr>" ;
                        }
                     }
                  ?>
                  <td align="right">X1
                     <input type="button" id="btnAjoutMot" name="btnAjoutMot" value="Ajout motif" class = "ui-state-default" onclick="motifnodet('<?php echo $zRef ; ?>');">
                   </td>
                  </table>
               </td>
            </tr>
            <tr>
               ...
               <td class="class4" colspan="2">
                  ...
                  <?php
                     ...
                     else
                     {
                        for($i = 0; $i < $iNbOrganis; $i ++)
                        {
                           ...
                           echo "<tr>
                                 <td>
                                    <textarea id = \"txtMotifOrganis".$i."\" name = \"txtMotifOrganis".$i."\"  style='width: 950px;'>". $toMotOrganis['libelle'] ."</textarea>
                                 </td>
                              </tr>" ;
                        }
                     }
                  ?>
                  <td align="right">x2
                     <input type="button" id="btnAjoutMot" name="btnAjoutMot" value="Ajout motif" class = "ui-state-default" onclick="motiforga('<?php echo $zRef ; ?>');">
                   </td>
                  </table>
               </td>
            </tr>
               ...
               <td class="class4" colspan="2">
                  ...
                  $nbrQueryTypo = pg_num_rows ($resTypologie);
                     ...
                     if (isset($oFNC['fnc_typologie']) && $oFNC['fnc_typologie'] !='')
                        ...
                        echo "<select id = \"txtAreaImputation\" name = \"txtAreaImputation\" style='width:200px;'>
                  ...
                  <?php
                     ...
                     if(($COQUAL == 78) && ($zStatutFNC != "bouclé") && $cur_cloturee == 1){
                        ...
                        elseif(($AC[1] != 0) && ($ANC[1] == 0)){
                           ...
                           if($AC[0] == 'ok'){
                              echo "Cl&ocirc;turer : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                              echo "	<select id = \"slctTraitStatut\" name = \"slctTraitStatut\" class = \"slct\" style = \"width: 200px\">
                                       <option value = \"\">********** fa&icirc;tes votre choix **********</option>
                           ...
                           if(($AC[0] == "ok") && ($ANC[0] == "ok")){ // toutes les actions sont ok
                              if(($oFNC['fnc_actionCStatut'] != "bouclé") && ($oFNC['fnc_actionNCStatut'] != "bouclé")){
                                 echo "Cl&ocirc;turer : &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
                                 echo "	<select id = \"slctTraitStatut\" name = \"slctTraitStatut\" class = \"slct\" style = \"width: 200px\" disabled='disabled'>
                                       <option value = \"\">********** fa&icirc;tes votre choix **********</option>
            ...
            <tr>
               ...
               <td class="class3" colspan="2">
                           ...
                           if($oFNC['fnc_actionCStatut'] != "bouclé"){
                              ...
                              echo "<tr>
                                    <td>
                                      ...
                                      <td class=\"class0\">
                                       <textarea class=\"classinput\" name=\"actDescCur_".$toActionCurative['action_id']." style='width: 950px;' >".$toActionCurative['action_description']."</textarea>
                                      </td>
                                      <td class=\"class0\">
                                    ...
                                    <td class=\"class0\">
                                     ...
                                     <td class=\"class0\">
                                          <select id=\"slctTraitStatutAction\" name=\"actEtatCur_".$toActionCurative['action_id']."\" style='width:200px;'>" ;
                        ?>
                        ...
                        <?php
                              ...
                              echo "<tr>
                                 <td>
                                   ...
                                   <td class=\"class0\">
                                    <textarea class=\"classinput\" name=\"actDescCur_".$toActionCurative['action_id']."\" readonly=\"readonly\" style='width: 950px;' >".$toActionCurative['action_description']."</textarea>
                                   </td>
                                   <td class=\"class0\">
                  ...
                  */
                  ?>
                     <div align="right">
                    <input type="button" id="btnAjoutActionC" name="btnAjoutActionC" value="Ajouter action" class = "ui-state-default" onclick="ajoutActCu('<?php echo $zRef; ?>');">
                  </div>
         ...
         <tr>
            ...
            <td class="class3" colspan="2">
                     ...
                     <?php
                                 ...
                                 echo "<tr>
                                       <td>
                                         ...
                                         <td class=\"class0\">
                                          <textarea class=\"classinput\" name=\"actDescNCur_".$i."\" style='width: 950px;' >{$aActionDesctiption[0]}</textarea>
                                         </td>
                                         <td class=\"class0\">
                                 ...
                                 echo "' /></td-->
                                       ...
                                       <td class=\"class0\">
                                          <select id=\"slctTraitStatutAction\" name=\"actEtatNCur_".$toActionNonCurative['info_id']."\" style='width:200px;'>" ;
                     ?>
                     ...
                     <?php
                                 ...
                                 echo "<tr>
                                    <td>
                                      ...
                                      <td class=\"class0\">
                                       <textarea class=\"classinput\" name=\"actDescNCur_".$i."\" readonly=\"readonly\" style='width: 950px;' >{$aActionDesctiption[0]}</textarea>
                                      </td>
                                      <td class=\"class0\">
               ...
               // echo getPersAccesNotation($_SESSION['matricule']);
                ...
                ?>
                  <div align="right">
           <input type="button" id="btnAjoutActionC" name="btnAjoutActionC" value="Ajouter action" class = "ui-state-default"  onclick="actcorr('<?php echo $iId; ?>');">
                  </div>
               <?php 
               }
