   ...
   <form id="frmApercu" name="frmApercu" action="" method="POST">
      ...
      ?>
         ...
         <table width="100%"  border="0" cellspacing="1" cellpadding="1">
            <tr>
               <td width="25%"><input type="button" id="btnModifier" name="btnModifier" value="Modifier" class = "ui-state-default" onclick="javascript:document.location.href ='FNCModifier.php?txtId=<?php echo $iId2 ; ?>&txtRef=<?php echo $zRef ; ?>&slctClientName=<?php echo $txtNameClient; ?>&txtCrationDate=<?php echo $createDate ; ?>&txtModifDate=<?php echo $modifDate ; ?>&txtCreateurMatr=<?php echo $createMatr ; ?>&motif_fnc=<?php echo $nc_motif ; ?>' "></td>
               ...
               <?php 
                     ...
                     if($testRef == 1) 
                     {
                           echo " <input type='button'name='btnRetour2' id='btnRetour2' value='Retour' onclick='myReload2();'class = 'ui-state-default'>";
                     }  
                     else
                     {
                         echo " <input type='button'name='btnRetour' id='btnRetour' value='Retour' onclick='myReload();'class = 'ui-state-default'>";
                     }
               ?>
      ...
      if(isset($_REQUEST['curative']))
      {
         ...
         echo "
            <script type='text/javascript'>
              ...
              document.location.replace('FNCModifier.php?txtId='+varId2+'&txtRef='+varZRef+'&txtNameClient='+slctClientName+'&txtCrationDate='+txtCrationDate+'&txtModifDate='+txtModifDate+'&txtCreateurMatr='+txtCreateurMatr+'&motif_fnc='+motif_fnc+'&curative=1');
            </script>";
      ...
      }elseif(isset($_REQUEST['corrective']))
      {
          echo "
            <script type='text/javascript'>
              ...
              document.location.replace('FNCModifier.php?txtId='+varId2+'&txtRef='+varZRef+'&txtNameClient='+slctClientName+'&txtCrationDate='+txtCrationDate+'&txtModifDate='+txtModifDate+'&txtCreateurMatr='+txtCreateurMatr+'&motif_fnc='+motif_fnc+'&corrective=1');
            </script>";
      }else
      {
         echo "
   ...
   function myReload2()
   {
      //window.location = "FNCSearch.php" ;
	   ...
	   //alert('9999');
        ...
        var matrSession = $("#idSessionMatr").val();//alert(matrSession);
        var userAcces = new Array(6548,7530,8108);
        var idCoqual = $("#idCoqual").val();//alert(idCoqual);
        var fncStatutBoucle = $("#fncStatutBoucle").val();
        var idFncValidite = $("#idFncValidite").val();//alert(idFncValidite);
        ...
        if(matrSession != 6548 && matrSession != 7530 && matrSession != 606 && matrSession != 9507 && matrSession != 7257 && matrSession != 42 && (fncStatutBoucle == 'boucl\351'))
        {
             disableInput('btnSupprimer');
        ...
        if(idCoqual != 78 && matrSession != 6548)
        {
            if(idFncValidite == 't')
               disableInput('btnValider');
              // alert('3');
        }
        if(matrSession != 6548 && matrSession != 7530 && matrSession != 7257 && matrSession != 42 && matrSession != 9507 && matrSession != 606)
        {
         // disableInput('btnSupprimer');
          // alert('4');
